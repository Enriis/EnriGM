...
RegisterServerEvent("en_f5:thief:ammanettaTarget", function(source, target)
    ...
    zTarget.triggerEvent("en_f5:thief:ammanettaTarget_c", 2)
end)

RegisterServerEvent("en_f5:thief:smanettaTarget", function(source, target)
    ...
    zTarget.triggerEvent("en_f5:thief:smanettaTarget_c", 2)
end)